...
namespace com.cortastudios.DynamicColorCorrection
{
    ...
    */
    public class ColorCurvesManager : MonoBehaviour
    {
        ...
        public static float chuj=1;
        public float Factor;

        // A configuration
        public float SaturationA = 1;
        public AnimationCurve RedA = new AnimationCurve(new Keyframe(0f, 0f), new Keyframe(.9f, .9f));  
        public AnimationCurve GreenA = new AnimationCurve(new Keyframe(0f, 0f), new Keyframe(0f, 0f));
        public AnimationCurve BlueA = new AnimationCurve(new Keyframe(0f, 0f), new Keyframe(.9f, .9f));

        public AnimationCurve RedADepth = new AnimationCurve(new Keyframe(0f, 0f), new Keyframe(.9f, .9f));
        public AnimationCurve GreenADepth = new AnimationCurve(new Keyframe(0f, 0f), new Keyframe(.9f, .9f));
        public AnimationCurve BlueADepth = new AnimationCurve(new Keyframe(0f, 0f), new Keyframe(.9f, .9f));

        public AnimationCurve ZCurveA = new AnimationCurve(new Keyframe(0f, 0f), new Keyframe(.9f, .9f));
        ...
        public AnimationCurve RedB = new AnimationCurve(new Keyframe(0f, 0f), new Keyframe(.9f, .9f));
        public AnimationCurve GreenB = new AnimationCurve(new Keyframe(0f, 0f), new Keyframe(.9f, .9f));
        public AnimationCurve BlueB = new AnimationCurve(new Keyframe(0f, 0f), new Keyframe(.9f, .9f));

        public AnimationCurve RedBDepth = new AnimationCurve(new Keyframe(0f, 0f), new Keyframe(.9f, .9f));
        public AnimationCurve GreenBDepth = new AnimationCurve(new Keyframe(0f, 0f), new Keyframe(.9f, .9f));
        public AnimationCurve BlueBDepth = new AnimationCurve(new Keyframe(0f, 0f), new Keyframe(.9f, .9f));
        ...
        void Start()
        {
            LastFactor = Factor;   /// tu bylo cos innego
